...
export default function TopNavbar() {
    ...
    return (
        <nav className="h-14 md:h-16 border-b border-white/10 bg-[#0f0f1a]/80 backdrop-blur-md sticky top-0 z-30 ml-0 md:ml-64 px-4 md:px-6 flex items-center justify-between">
