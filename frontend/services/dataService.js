...
class DataService {
    ...
    processIncomingEvent(event) {
        // Update Global Stats
        this.globalStats.total_analyzed += 1;
        if (event.attack_type === 'Normal') {
            this.globalStats.allowed += 1;
        } else {
            this.globalStats.blocked += 1;
            this.globalStats.attack_types[event.attack_type] = (this.globalStats.attack_types[event.attack_type] || 0) + 1;
        }
